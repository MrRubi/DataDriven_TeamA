...
#Analisis de la actividad de distintos honeypots
...
#Primera pregunta: Honeypot mas atacado
...
#Segunda pregunta: Protocolos y puertos mas utilizados en los ataques
...
Hasta ahora, en la primera pregunta (o analisis) hemos analizado el volumen de ataques y su procedencia, intentando determinar los paises mas activos así como los honeypots mas atacados. Hemos podido descubrir que Estados unidos forma parte de los paises mas atacados,como era de esperar, dada su relevancia mundial, del mismo modo que los paises asiaticos tienen una gran actividad en los honeypots, corroborando la fama que les precede en cuanto a ciberdelincuencia.
...
Por último, pretendemos relacionar, en cierto modo, la primera y segunda pregunta, combinando cada honeypot con sus puertos mas atacados e intentar determinar si existe algún tipo de relación. Los puertos atacados son el mismo para todos? Hay que tener en cuenta que alomejor el sistema operativo y servicios presentes en cada honeypot son distintos, ya que no disponemos de ese tipo de información. 
