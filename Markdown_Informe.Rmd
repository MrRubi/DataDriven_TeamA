...
Al ver el resultado en los gráficos UDP, podemos concluir que no hay un patrón común para los ataques, ya que cada honeypot tiene un puerto más atacado que otro y no son los mismos en cada uno, por lo tanto, hay un amplio abanico de ataques y sin práctimente patrones de repetición en los puertos más atacados, a diferencia de TCP (si que se repiten algunos, como hemos comentado anteriormente, pero da la casualidad que no son los más atacados).
